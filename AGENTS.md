...
Then exercise TXT import, selectable-PDF import, scanned-PDF failure, a valid MP3, a long-job ETA, cancellation cleanup, `Command-O`, and the accessibility reading order. Keep built, tested, released, downloaded, and installed states separate.
